...
const StrokeText = ({
  ...
  const wipeId = `stroke-text-wipe-${cleanId}`;
  const customGradId = gradientId || `stroke-text-grad-${cleanId}`;
  ...
  const computedFill = gradientStops ? `url(#${customGradId})` : fillColor;
    ...
    >
      <svg className="stroke-text__svg" viewBox={viewBox} preserveAspectRatio="xMidYMid meet" aria-hidden="true">
        <defs>
          ...
          {gradientStops && (
            <linearGradient id={customGradId} x1="0%" y1="0%" x2="100%" y2="0%">
