...
const GLOBE_CONFIG = {
  ...
  mapBrightness: 1.2,
  baseColor: [1, 1, 1],
  markerColor: [251 / 255, 100 / 255, 21 / 255], // Glowing bright orange (#fb6415)
  glowColor: [1, 1, 1],
  markers: [
    { location: [36.2917, 139.8789], size: 0.1 }, // Yuki-shi, Ibaraki, Japan (Nagomi Lanka Tours)
    { location: [7.8731, 80.7718], size: 0.1 },   // Sri Lanka (Maneesh HQ)
    { location: [37.7749, -122.4194], size: 0.08 }, // San Francisco
    { location: [40.7128, -74.006], size: 0.08 },   // New York
    { location: [51.5074, -0.1278], size: 0.07 },   // London, UK
    { location: [19.076, 72.8777], size: 0.07 },    // India
