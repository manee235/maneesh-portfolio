...
const Features = ({ isDarkMode }) => {
  ...
  return (
    ...
    >
      <div className="section-bg-title">Features</div>
      <div className="features-bento-grid">

        {/* Row 1, Col 1: Hero card */}
        <motion.div className="feature-card feature-hero-card" variants={itemVariants}>
          <h1>Features<br />Offered<br />By Me</h1>
          <p className="hero-desc">
            Delivering comprehensive digital solutions tailored to your needs,
            ranging from high-end UI design to robust, scalable backends.
          </p>
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <button className="create-project-btn" onClick={scrollToContact}>
              + Start a Project
            </button>
          </div>
        </motion.div>
        ...
        <motion.div className="feature-card-wrapper" variants={itemVariants}>
          <BorderGlow
            className="feature-card"
            backgroundColor={isDarkMode ? "rgba(20, 20, 20, 0.7)" : "rgba(248, 249, 250, 0.7)"}
            glowColor={isDarkMode ? "231 100 65" : "227 76 58"}
            colors={isDarkMode ? ['#4f6bff', '#a855f7', '#00d989'] : ['#4461e6', '#c084fc', '#00a86b']}
            borderRadius={28}
            glowRadius={40}
            edgeSensitivity={30}
          >
            ...
            <div className="card-skill-progress">
              ...
              <div className="progress-bar-bg">
                <motion.div className="progress-bar-fill"
                  ...
                  initial={{ width: 0 }} whileInView={{ width: "90%" }}
